...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-auto items-center justify-center rounded-xl bg-muted p-1.5 text-muted-foreground flex-wrap gap-1",
      className
    )}
    {...props}
  />
