            ...
            <Card>
              <CardContent className="pt-6">
                <div className="mb-8">
                  ...
                  <h4 className="text-xl font-semibold mt-4 mb-3">1.3. Site Owner Contact Details</h4>
                  <div className="overflow-x-auto">
                    <table className="w-full border-collapse border border-gray-300">
                      <thead>
                        <tr className="bg-gray-100">
                ...
                <div className="mb-8">
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full border-collapse border border-gray-300">
                      ...
                      <tbody>
                        <TableInputRow
                          label="Cable Access to Equipment Room"
                          name="cableAccess"
                  ...
                  <div className="overflow-x-auto">
                    <table className="w-full border-collapse border border-gray-300">
                      ...
                      <tbody>
                        <tr className="border border-gray-300">
                          <td className="border border-gray-300 p-2 font-medium">Number of Routers</td>
                          <td className="border border-gray-300 p-1">
                            <Input
                              type="number"
                        ...
                        <tr className="border border-gray-300">
                          <td className="border border-gray-300 p-2 font-medium">Please red-line Room Layout Drawing to indicate:</td>
                          <td className="border border-gray-300 p-1">
                            <Textarea
                              value={cabinetSpacePlanning.roomLayoutMarkup}
                              onChange={(e) => handleCabinetSpacePlanningChange('roomLayoutMarkup', e.target.value)}
                              className="border-0 focus-visible:ring-0 h-64 w-full"
                              placeholder="1. New equipment placement&#10;2. Rack elevation details&#10;3. Required floor space&#10;4. Entry and exit points&#10;5. Hazards or obstacles"
                            />
                          </td>
                        </tr>
                      </tbody>
                  ...
                  <h4 className="text-xl font-semibold mt-4 mb-3">4. APPROVALS AND SIGN-OFF</h4>
                  <div className="space-y-6">
                    <div className="border p-4 rounded-md">
                      <h5 className="font-semibold mb-3">OEM Contractor Sign-off</h5>
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) => {
                              ...
                              if (checked) handleApprovalChange('oemContractor', 'rejected', false);
                            }}
                          />
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) => {
                              ...
                              if (checked) handleApprovalChange('oemContractor', 'accepted', false);
                            }}
                          />
                  ...
                  <div className="flex justify-end space-x-4 mt-10">
                    <Button type="button" onClick={handleSaveForLater} className="bg-gray-500 hover:bg-gray-600">
                      <Save className="mr-2 h-4 w-4" /> Save for Later
                    </Button>
                    <Button type="submit" className="bg-akhanya hover:bg-akhanya-dark">
                      Submit Survey
                    </Button>
                  </div>
